...
import { MapPin, Calendar, Weight, Building2, CheckCircle, X } from "lucide-react";
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0 gap-0 bg-card border-border">
        ...
        <div className="relative aspect-[16/9] overflow-hidden">
          ...
          <Button
            ...
            size="icon"
            onClick={onClose}
            className="absolute top-4 right-4 bg-background/80 hover:bg-background text-foreground rounded-full h-10 w-10"
          >
            <X className="h-5 w-5" />
          </Button>
        </div>
